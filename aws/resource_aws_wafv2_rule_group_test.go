		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfawsresource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						// TODO: super nested TypeSet check
						"statement.0.byte_match_statement.0.text_transformation.4292479961.priority": "5",
						"statement.0.byte_match_statement.0.text_transformation.4292479961.type":     "NONE",
						"statement.0.byte_match_statement.0.text_transformation.2156930824.priority": "2",
						"statement.0.byte_match_statement.0.text_transformation.2156930824.type":     "LOWERCASE",
					}),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfawsresource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						// TODO: super nested TypeSet check
						"statement.0.byte_match_statement.0.text_transformation.766585421.priority": "3",
						"statement.0.byte_match_statement.0.text_transformation.766585421.type":     "CMD_LINE",
					}),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfawsresource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						// TODO: super nested TypeSet check
						"statement.0.sqli_match_statement.0.text_transformation.1247795808.priority": "5",
						"statement.0.sqli_match_statement.0.text_transformation.1247795808.type":     "URL_DECODE",
						"statement.0.sqli_match_statement.0.text_transformation.2156930824.priority": "2",
						"statement.0.sqli_match_statement.0.text_transformation.2156930824.type":     "LOWERCASE",
					}),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfawsresource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						"statement.0.sqli_match_statement.0.text_transformation.1247795808.priority": "5",
						"statement.0.sqli_match_statement.0.text_transformation.1247795808.type":     "URL_DECODE",
						"statement.0.sqli_match_statement.0.text_transformation.4120379776.priority": "4",
						"statement.0.sqli_match_statement.0.text_transformation.4120379776.type":     "HTML_ENTITY_DECODE",
						"statement.0.sqli_match_statement.0.text_transformation.1521630275.priority": "3",
						"statement.0.sqli_match_statement.0.text_transformation.1521630275.type":     "COMPRESS_WHITE_SPACE",
					}),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfawsresource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						// TODO: super nested TypeSet check
						"statement.0.xss_match_statement.0.text_transformation.2336416342.priority": "2",
						"statement.0.xss_match_statement.0.text_transformation.2336416342.type":     "NONE",
					}),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfawsresource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						"statement.0.xss_match_statement.0.text_transformation.#":   "1",
						// TODO: super nested TypeSet check
						"statement.0.xss_match_statement.0.text_transformation.2876362756.priority": "2",
						"statement.0.xss_match_statement.0.text_transformation.2876362756.type":     "URL_DECODE",
					}),
				),
			},
			{
